        ...
        <div className="bg-slate-200 min-h-screen flex justify-center pt-[5%]">
            ...
            <div className="bg-white rounded-lg shadow-lg w-[80%] p-[5%] mt-8 flex flex-col md:flex-row justify-between items-start">
                ...
                <div className="flex flex-col w-full md:w-[60%]">
                    <h2 className="text-3xl font-bold text-slate-800 mb-4"><span className="text-teal-700">Instant</span> & <span className="text-teal-700">Scalable</span> Cloud Solutions</h2>
                    <h3 className="text-xl text-slate-600 mb-4">Build and Deploy your products with ease</h3>
